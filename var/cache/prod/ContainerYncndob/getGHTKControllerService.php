...
// Returns the public 'Plugin\ghtk\Controller\Admin\GHTKController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ghtk/Controller/Admin/GHTKController.php';
...
$this->services['Plugin\ghtk\Controller\Admin\GHTKController'] = $instance = new \Plugin\ghtk\Controller\Admin\GHTKController(${($_ = isset($this->services['Plugin\ghtk\Service\GhtkApi']) ? $this->services['Plugin\ghtk\Service\GhtkApi'] : $this->load('getGhtkApiService.php')) && false ?: '_'}, ${($_ = isset($this->services['Plugin\ghtk\Repository\ConfigRepository']) ? $this->services['Plugin\ghtk\Repository\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'}, $a);
