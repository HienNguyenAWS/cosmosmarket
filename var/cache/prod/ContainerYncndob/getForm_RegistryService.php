...
}, 'Plugin\\ghtk\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\ghtk\Form\Type\Admin\ConfigType']) ? $this->services['Plugin\ghtk\Form\Type\Admin\ConfigType'] : ($this->services['Plugin\ghtk\Form\Type\Admin\ConfigType'] = new \Plugin\ghtk\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\ghtk\\Form\\Type\\Admin\\GHTKProductType' => function () {
    return ${($_ = isset($this->services['Plugin\ghtk\Form\Type\Admin\GHTKProductType']) ? $this->services['Plugin\ghtk\Form\Type\Admin\GHTKProductType'] : $this->load('getGHTKProductTypeService.php')) && false ?: '_'};
