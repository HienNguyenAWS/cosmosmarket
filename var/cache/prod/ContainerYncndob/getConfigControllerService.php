...
// Returns the public 'Plugin\ghtk\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/ghtk/Controller/Admin/ConfigController.php';

$this->services['Plugin\ghtk\Controller\Admin\ConfigController'] = $instance = new \Plugin\ghtk\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\ghtk\Repository\ConfigRepository']) ? $this->services['Plugin\ghtk\Repository\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'});
