...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'eccube\\service\\composer\\composerprocessservice' => 'Eccube\\Service\\Composer\\ComposerProcessService',
            ...
            'eccube\\twig\\environment' => 'Eccube\\Twig\\Environment',
            'eccube\\twig\\extension\\eccubeextension' => 'Eccube\\Twig\\Extension\\EccubeExtension',
            'eccube\\twig\\extension\\intlextension' => 'Eccube\\Twig\\Extension\\IntlExtension',
            ...
            'plugin\\ghtk\\controller\\admin\\configcontroller' => 'Plugin\\ghtk\\Controller\\Admin\\ConfigController',
            'plugin\\ghtk\\controller\\admin\\ghtkcontroller' => 'Plugin\\ghtk\\Controller\\Admin\\GHTKController',
            'plugin\\ghtk\\event' => 'Plugin\\ghtk\\Event',
            'plugin\\ghtk\\form\\type\\admin\\configtype' => 'Plugin\\ghtk\\Form\\Type\\Admin\\ConfigType',
            'plugin\\ghtk\\form\\type\\admin\\ghtkproducttype' => 'Plugin\\ghtk\\Form\\Type\\Admin\\GHTKProductType',
            'plugin\\ghtk\\repository\\configrepository' => 'Plugin\\ghtk\\Repository\\ConfigRepository',
            'plugin\\ghtk\\repository\\ghtkorderstatusrepository' => 'Plugin\\ghtk\\Repository\\GhtkOrderStatusRepository',
            'plugin\\ghtk\\service\\ghtkapi' => 'Plugin\\ghtk\\Service\\GhtkApi',
        ...
        $this->methodMap = [
            ...
            'Eccube\\Twig\\Environment' => 'getEnvironmentService',
            'Eccube\\Twig\\Extension\\EccubeExtension' => 'getEccubeExtensionService',
            'Eccube\\Twig\\Extension\\IntlExtension' => 'getIntlExtensionService',
        ...
        $this->fileMap = [
            ...
            'Eccube\\Repository\\TaxRuleRepository' => 'getTaxRuleRepositoryService.php',
            ...
            'Eccube\\Service\\Composer\\ComposerProcessService' => 'getComposerProcessServiceService.php',
            ...
            'Plugin\\ghtk\\Controller\\Admin\\ConfigController' => 'getConfigControllerService.php',
            'Plugin\\ghtk\\Controller\\Admin\\GHTKController' => 'getGHTKControllerService.php',
            'Plugin\\ghtk\\Event' => 'getEventService.php',
            'Plugin\\ghtk\\Form\\Type\\Admin\\ConfigType' => 'getConfigTypeService.php',
            'Plugin\\ghtk\\Form\\Type\\Admin\\GHTKProductType' => 'getGHTKProductTypeService.php',
            'Plugin\\ghtk\\Repository\\ConfigRepository' => 'getConfigRepositoryService.php',
            'Plugin\\ghtk\\Repository\\GhtkOrderStatusRepository' => 'getGhtkOrderStatusRepositoryService.php',
            'Plugin\\ghtk\\Service\\GhtkApi' => 'getGhtkApiService.php',
            ...
            'security.request_matcher.188488n' => 'getSecurity_RequestMatcher_188488nService.php',
        ...
        $this->privates = [
            ...
            'Plugin\\ghtk\\Event' => true,
            'Plugin\\ghtk\\Form\\Type\\Admin\\ConfigType' => true,
            'Plugin\\ghtk\\Form\\Type\\Admin\\GHTKProductType' => true,
            'Plugin\\ghtk\\Repository\\ConfigRepository' => true,
            'Plugin\\ghtk\\Repository\\GhtkOrderStatusRepository' => true,
            'Plugin\\ghtk\\Service\\GhtkApi' => true,
            ...
            'security.request_matcher.188488n' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/EntityExtension/Entity')]), 'Plugin\\EntityExtension\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/EntityForm/Entity')]), 'Plugin\\EntityForm\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/MigrationSample/Entity')]), 'Plugin\\MigrationSample\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, [0 => ($this->targetDirs[3].'/app/Plugin/ghtk/Entity')]), 'Plugin\\ghtk\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Repository\\AuthorityRoleRepository' => function () {
            ...
            return ${($_ = isset($this->services['Eccube\Repository\TaxRuleRepository']) ? $this->services['Eccube\Repository\TaxRuleRepository'] : $this->load('getTaxRuleRepositoryService.php')) && false ?: '_'};
        ...
        }, 'Plugin\\ghtk\\Repository\\ConfigRepository' => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Repository\ConfigRepository']) ? $this->services['Plugin\ghtk\Repository\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'};
        }, 'Plugin\\ghtk\\Repository\\GhtkOrderStatusRepository' => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Repository\GhtkOrderStatusRepository']) ? $this->services['Plugin\ghtk\Repository\GhtkOrderStatusRepository'] : $this->load('getGhtkOrderStatusRepositoryService.php')) && false ?: '_'};
        }])));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.terminate', [0 => function () {
            return ${($_ = isset($this->services['Eccube\Util\CacheUtil']) ? $this->services['Eccube\Util\CacheUtil'] : ($this->services['Eccube\Util\CacheUtil'] = new \Eccube\Util\CacheUtil(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}))) && false ?: '_'};
        }, 1 => 'forceClearCache'], 0);
        $instance->addListener('@admin/Setting/Shop/delivery_edit.twig', [0 => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Event']) ? $this->services['Plugin\ghtk\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'deliveryEdit'], 0);
        $instance->addListener('@admin/Order/edit.twig', [0 => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Event']) ? $this->services['Plugin\ghtk\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'downloadGhtkOrder'], 0);
        ...
        $instance->addListener('admin.product.edit.initialize', [0 => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Event']) ? $this->services['Plugin\ghtk\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'productEditEvent'], 0);
        $instance->addListener('front.shopping.complete.initialize', [0 => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Event']) ? $this->services['Plugin\ghtk\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'createGhtkOrder'], 0);
        $instance->addListener('admin.order.edit.index.progress', [0 => function () {
            return ${($_ = isset($this->services['Plugin\ghtk\Event']) ? $this->services['Plugin\ghtk\Event'] : $this->load('getEventService.php')) && false ?: '_'};
        }, 1 => 'orderEdit'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, ['paths' => [($this->targetDirs[3].'/app/Plugin/ghtk/Resource/template') => 'ghtk', ($this->targetDirs[3].'/app/template/'.$this->getEnv('string:ECCUBE_TEMPLATE_CODE')) => NULL, ($this->targetDirs[3].'/src/Eccube/Resource/template/default') => NULL, ($this->targetDirs[3].'/app/Plugin') => NULL, ($this->targetDirs[3].'/app/template/admin') => 'admin', ($this->targetDirs[3].'/src/Eccube/Resource/template/admin') => 'admin', ($this->targetDirs[3].'/app/template/user_data') => 'user_data', ($this->targetDirs[3].'/src/Eccube/Resource/template/toolbar') => 'toolbar', ($this->targetDirs[3].'/src/Eccube/Resource/template/common') => 'common'], 'debug' => false, 'strict_variables' => false, 'form_themes' => $this->parameters['twig.form.resources'], 'date' => ['timezone' => $this->getEnv('ECCUBE_TIMEZONE'), 'format' => 'F j, Y H:i', 'interval_format' => '%d days'], 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
        ...
        $instance->addExtension(${($_ = isset($this->services['Eccube\Twig\Extension\IntlExtension']) ? $this->services['Eccube\Twig\Extension\IntlExtension'] : ($this->services['Eccube\Twig\Extension\IntlExtension'] = new \Eccube\Twig\Extension\IntlExtension())) && false ?: '_'});
        ...
        $instance->addExtension(new \Eccube\Twig\Extension\TwigIncludeExtension(${($_ = isset($this->services['Eccube\Twig\Environment']) ? $this->services['Eccube\Twig\Environment'] : $this->getEnvironmentService()) && false ?: '_'}));
    ...
    /*
     * Gets the private 'Eccube\Twig\Environment' shared autowired service.
     *
     * @return \Eccube\Twig\Environment
     */
    protected function getEnvironmentService()
    {
        $a = ${($_ = isset($this->services['twig']) ? $this->services['twig'] : $this->getTwigService()) && false ?: '_'};

        if (isset($this->services['Eccube\Twig\Environment'])) {
            return $this->services['Eccube\Twig\Environment'];
        }

        return $this->services['Eccube\Twig\Environment'] = new \Eccube\Twig\Environment($a, ${($_ = isset($this->services['event_dispatcher']) ? $this->services['event_dispatcher'] : $this->getEventDispatcherService()) && false ?: '_'});
    }
    ...
    /*
     * Gets the private 'Eccube\Twig\Extension\IntlExtension' shared autowired service.
     *
     * @return \Eccube\Twig\Extension\IntlExtension
     */
    protected function getIntlExtensionService()
    {
        return $this->services['Eccube\Twig\Extension\IntlExtension'] = new \Eccube\Twig\Extension\IntlExtension();
    }
    ...
    {
        $this->services['monolog.handler.admin'] = $instance = new \Monolog\Handler\FingersCrossedHandler(${($_ = isset($this->services['monolog.handler.admin_rotating_file']) ? $this->services['monolog.handler.admin_rotating_file'] : $this->getMonolog_Handler_AdminRotatingFileService()) && false ?: '_'}, 400, 0, true, true, 200);
    ...
    {
        $this->services['monolog.handler.front'] = $instance = new \Monolog\Handler\FingersCrossedHandler(${($_ = isset($this->services['monolog.handler.front_rotating_file']) ? $this->services['monolog.handler.front_rotating_file'] : $this->getMonolog_Handler_FrontRotatingFileService()) && false ?: '_'}, 400, 0, true, true, 200);
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\FingersCrossedHandler(${($_ = isset($this->services['monolog.handler.main_rotating_file']) ? $this->services['monolog.handler.main_rotating_file'] : $this->getMonolog_Handler_MainRotatingFileService()) && false ?: '_'}, 400, 0, true, true, 200);
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.188488n']) ? $this->services['security.request_matcher.188488n'] : ($this->services['security.request_matcher.188488n'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        }]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), $this->getEnv('ECCUBE_LOCALE'), ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => false, 'resource_files' => ['af' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.af.xlf')], 'ar' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ar.xliff')], 'az' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.az.xlf')], 'bg' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.bg.xlf')], 'ca' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ca.xlf')], 'cs' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.cs.xlf')], 'cy' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cy.xlf')], 'da' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.da.xliff')], 'de' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.de.xliff')], 'el' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.el.xlf')], 'en' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.en.xliff'), 4 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/messages.en.yaml'), 5 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/validators.en.yaml')], 'es' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.es.xliff')], 'et' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.et.xlf')], 'eu' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.eu.xlf')], 'fa' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fa.xliff')], 'fi' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fi.xlf')], 'fr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fr.xliff')], 'gl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.gl.xlf')], 'he' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.he.xlf')], 'hr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.hr.xlf')], 'hu' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.hu.xliff')], 'hy' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hy.xlf')], 'id' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.id.xliff')], 'it' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.it.xliff')], 'ja' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/app/Plugin/ghtk/Resource/locale/messages.ja.yaml'), 4 => ($this->targetDirs[3].'/app/Plugin/ghtk/Resource/locale/validators.ja.yaml'), 5 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/messages.ja.yaml'), 6 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/validators.ja.yaml')], 'lb' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lb.xlf')], 'lt' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.lt.xliff')], 'lv' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lv.xlf')], 'mn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.mn.xlf')], 'nb' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nb.xlf')], 'nl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.nl.xliff')], 'nn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nn.xlf')], 'no' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.no.xlf')], 'pl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pl.xliff')], 'pt' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt.xlf')], 'pt_BR' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pt_BR.xliff')], 'ro' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ro.xliff')], 'ru' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ru.xliff')], 'sk' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sk.xlf')], 'sl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sl.xlf')], 'sq' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sq.xlf')], 'sr_Cyrl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sr_Cyrl.xlf')], 'sr_Latn' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sr_Latn.xlf')], 'sv' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sv.xliff')], 'th' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.th.xlf')], 'tl' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.tl.xlf')], 'tr' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.tr.xlf')], 'uk' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.uk.xliff')], 'vi' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.vi.xlf'), 3 => ($this->targetDirs[3].'/app/Plugin/ghtk/Resource/locale/messages.vi.yaml'), 4 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/messages.vi.yaml'), 5 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/validators.vi.yaml')], 'zh_CN' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.zh_CN.xlf')], 'zh_TW' => [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf')], 'pt_PT' => [0 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pt_PT.xlf')], 'ua' => [0 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ua.xlf')], 'ky' => [0 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ky.xliff')], 'sw' => [0 => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sw.xliff')], 'vi_BK' => [0 => ($this->targetDirs[3].'/src/Eccube/Resource/locale/messages.vi_BK.yaml_BK')]]]);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/app/Plugin/ghtk/Resource/template'), 'ghtk');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'eccube_content_maintenance_file_path': $value = ($this->targetDirs[3].'/.maintenance'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'env(ECCUBE_LOCALE)' => 'vi',
            'env(ECCUBE_TIMEZONE)' => 'Asia/Ho_Chi_Minh',
            'env(ECCUBE_CURRENCY)' => 'VND',
            'env(DATABASE_URL)' => '',
            ...
            'eccube_csv_export_date_format' => 'H:i:s d-m-Y',
            ...
            'eccube_official_site_url' => 'http://ec-cube.vn',
            'eccube_community_site_url' => 'https://www.facebook.com/groups/eccube.vn/',
            'eccube_document_url' => 'http://docs.ec-cube.vn/',
            'eccube_name_len' => 20,
            'eccube_kana_len' => 25,
            'eccube_address1_len' => 50,
            'eccube_address2_len' => 50,
            ...
            'eccube_order_pdf_message_len' => 50,
            'eccube_order_pdf_font' => 'dejavusans',
            ...
            'env(MAILER_URL)' => '',
            'stt_m1' => 'Huỷ đơn hàng',
            'stt_1' => 'Chưa tiếp nhận',
            'stt_2' => 'Đã tiếp nhận',
            'stt_3' => 'Đã lấy hàng / Đã nhập kho',
            'stt_4' => 'Đã điều phối giao hàng/Đang giao hàng',
            'stt_5' => 'Đã giao hàng/Chưa đối soát',
            'stt_6' => 'Đã đối soát',
            'stt_7' => 'Không lấy được hàng',
            'stt_8' => 'Hoãn lấy hàng',
            'stt_9' => 'Không giao được hàng',
            'stt_10' => 'Delay giao hàng',
            'stt_11' => 'Đã đối soát công nợ trả hàng',
            'stt_12' => 'Đã điều phối lấy hàng/Đang lấy hàng',
            'stt_13' => 'Đơn hàng bồi hoàn',
            'stt_20' => 'Đang trả hàng (COD cầm hàng đi trả)',
            'stt_21' => 'Đã trả hàng (COD đã trả xong hàng)',
            'stt_123' => 'Shipper báo đã lấy hàng',
            'stt_127' => 'Shipper (nhân viên lấy/giao hàng) báo không lấy được hàng',
            'stt_128' => 'Shipper báo delay lấy hàng',
            'stt_45' => 'Shipper báo đã giao hàng',
            'stt_49' => 'Shipper báo không giao được giao hàng',
            'stt_410' => 'Shipper báo delay giao hàng',
