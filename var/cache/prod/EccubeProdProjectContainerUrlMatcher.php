...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Admin')) {
            ...
            if (0 === strpos($pathinfo, '/Admin/s')) {
                ...
                if (0 === strpos($pathinfo, '/Admin/se')) {
                    ...
                    if ('/Admin/search_nonstock' === $pathinfo) {
                    ...
                    if ('/Admin/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/Admin/setting/shop/csv') && preg_match('#^/Admin/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/Admin/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/Admin/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/Admin/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/Admin/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/Admin/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/Admin/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/Admin/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/Admin/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/Admin/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/Admin/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/Admin/setting/system')) {
                        // admin_setting_system_authority
                        if ('/Admin/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/Admin/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/Admin/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/Admin/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/Admin/setting/system/member' === $pathinfo) {
                            ...
                            if ('/Admin/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/Admin/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/Admin/setting/system/system' === $pathinfo) {
                            ...
                            if ('/Admin/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/Admin/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/Admin/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/Admin/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/shipping/preview_notify_mail') && preg_match('#^/Admin/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/shipping/notify_mail') && preg_match('#^/Admin/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/Admin/store/plugin')) {
                    if (0 === strpos($pathinfo, '/Admin/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/Admin/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/Admin/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/Admin/store/plugin/api/search/page') && preg_match('#^/Admin/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/Admin/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/Admin/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/store/plugin/api/delete') && preg_match('#^/Admin/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/Admin/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/Admin/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/Admin/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/Admin/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/Admin/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/Admin/store/template')) {
                    // admin_store_template
                    if ('/Admin/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/Admin/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/Admin/c')) {
                ...
                if ('/Admin/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/Admin/content')) {
                    if (0 === strpos($pathinfo, '/Admin/content/block')) {
                        // admin_content_block
                        if ('/Admin/content/block' === $pathinfo) {
                        ...
                        if ('/Admin/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/Admin/content/cache' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/content/file_')) {
                        // admin_content_file
                        if ('/Admin/content/file_manager' === $pathinfo) {
                        ...
                        if ('/Admin/content/file_view' === $pathinfo) {
                        ...
                        if ('/Admin/content/file_delete' === $pathinfo) {
                        ...
                        if ('/Admin/content/file_download' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/content/layout')) {
                        // admin_content_layout
                        if ('/Admin/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/content/news')) {
                        // admin_content_news
                        if ('/Admin/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/content/news/page') && preg_match('#^/Admin/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/Admin/content/page')) {
                        // admin_content_page
                        if ('/Admin/content/page' === $pathinfo) {
                        ...
                        if ('/Admin/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/Admin/customer')) {
                    // admin_customer
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/Admin/customer/page') && preg_match('#^/Admin/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/Admin/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/Admin/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/Admin/order')) {
                // admin_shipping_csv_import
                if ('/Admin/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/Admin/order/csv_template' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/Admin/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/Admin/order/search')) {
                    if (0 === strpos($pathinfo, '/Admin/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/Admin/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/order/search/customer/html/page') && preg_match('#^/Admin/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/order/search/product')) {
                        // admin_order_search_product
                        if ('/Admin/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/Admin/order/search/product/page') && preg_match('#^/Admin/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/Admin/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/Admin/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/Admin/order/page') && preg_match('#^/Admin/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/Admin/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/Admin/order/export')) {
                    // admin_order_export_order
                    if ('/Admin/order/export/order' === $pathinfo) {
                    ...
                    if ('/Admin/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/Admin/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/Admin/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/Admin/product')) {
                if (0 === strpos($pathinfo, '/Admin/product/c')) {
                    if (0 === strpos($pathinfo, '/Admin/product/category')) {
                        // admin_product_category
                        if ('/Admin/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/Admin/product/category/export' === $pathinfo) {
                        ...
                        if ('/Admin/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/Admin/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/Admin/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/Admin/product/class_name')) {
                        // admin_product_class_name
                        if ('/Admin/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/Admin/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/Admin/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/Admin/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/Admin/product/csv_template') && preg_match('#^/Admin/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/Admin/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/Admin/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/Admin/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/Admin/product/page') && preg_match('#^/Admin/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/Admin/product/product')) {
                    // admin_product_image_add
                    if ('/Admin/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/Admin/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/Admin/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/Admin/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/Admin/product/classes') && preg_match('#^/Admin/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/Admin/product/bulk/product-status') && preg_match('#^/Admin/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/Admin/product/tag')) {
                    // admin_product_tag
                    if ('/Admin/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/Admin/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/Admin/product/tag/sort_no/move' === $pathinfo) {
            ...
            // ghtk_admin_config
            if ('/Admin/ghtk/config' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\ghtk\\Controller\\Admin\\ConfigController::index',  '_route' => 'ghtk_admin_config',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_ghtk_admin_config;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'ghtk_admin_config', key($requiredSchemes)));
                }

                return $ret;
            }
            not_ghtk_admin_config:

            // ghtk_admin_download_pdf
            if ('/Admin/ghtk/download_pdf' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\ghtk\\Controller\\Admin\\GHTKController::index',  '_route' => 'ghtk_admin_download_pdf',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_ghtk_admin_download_pdf;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'ghtk_admin_download_pdf', key($requiredSchemes)));
                }

                return $ret;
            }
            not_ghtk_admin_download_pdf:
        ...
        elseif (0 === strpos($pathinfo, '/entry')) {
            ...
            // entry_activate
            if (0 === strpos($pathinfo, '/entry/activate') && preg_match('#^/entry/activate/(?P<secret_key>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'entry_activate']), array (  '_controller' => 'Eccube\\Controller\\EntryController::activate',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/help')) {
            ...
            // help_postalcode
            if ('/help/postalcode' === $pathinfo) {
                $ret = array (  '_controller' => 'Eccube\\Controller\\HelpController::postalcode',  '_route' => 'help_postalcode',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_help_postalcode;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'help_postalcode', key($requiredSchemes)));
                }
        ...
        // ghtk_admin_webhook
        if ('/ghtk/webhook' === $pathinfo) {
            $ret = array (  '_controller' => 'Plugin\\ghtk\\Controller\\Admin\\GHTKController::callback',  '_route' => 'ghtk_admin_webhook',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            if (!isset($requiredSchemes[$context->getScheme()])) {
                if ('GET' !== $canonicalMethod) {
                    goto not_ghtk_admin_webhook;
                }

                return array_replace($ret, $this->redirect($rawPathinfo, 'ghtk_admin_webhook', key($requiredSchemes)));
            }

            return $ret;
        }
        not_ghtk_admin_webhook:
